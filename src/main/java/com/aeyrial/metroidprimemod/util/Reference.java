package com.aeyrial.metroidprimemod.util;

public class Reference {

	public static final String MOD_ID = "mpm";
	public static final String NAME = "Metroid Prime Mod";
	...
	public static final int ENTITY_WAR_WASP = 123;
}
